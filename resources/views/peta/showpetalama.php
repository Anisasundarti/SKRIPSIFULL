  ...
  function batas_kecamatan (feature) {
   ...
   function tutupan_lahan (feature) {
    var warna1={
     ...
     function fixtutupanlahan1 (feature) {
    var warna5={
      "fillColor" :"#8A2BE2", //Blue Violet 
      "color" :" #ffffff",
      "weight":"1",
      ...
      if(feature.properties.Skor==2){ //pemukiman
         warna5.fillColor = "#D2691E" //Chocolate  
         return warna5;
       }
        else {
           warna5.fillColor="#9ACD32" //Yellow Green 
          return warna5;
       }}

       function fixpenerangan1 (feature) {
    var warna3={
      "fillColor" :"#8A2BE2", //Blue Violet 
      "color" :" #ffffff",
      "weight":"1",
      ...
      if(feature.properties.Status==1){ //penerangan
         warna3.fillColor = "#D2691E" //Chocolate  
         return warna3;
       }
        else {
           warna3.fillColor="#9ACD32" //Yellow Green 
          return warna3;
       }}

       function analisadata2019 (feature) {
    var warna4={
      "fillColor" :"#8A2BE2", //Blue Violet 
      "color" :" #ffffff",
      "weight":"1",
      ...
      if(feature.properties.Tingkat_Ke=="Sangat Rawan"){
         warna4.fillColor = "#D2691E" //Chocolate  
         return warna4;
       }
       else if(feature.properties.Tingkat_Ke=="Rawan"){
           warna4.fillColor ="#006400" //Dark Green
          return warna4;
       }
        else {
           warna4.fillColor="#9ACD32" //Yellow Green 
          return warna4;
       }}
...
//Layer Data Peta
  ...
  var fix_tutupan_lahan=L.geoJSON(fixtutupanlahan, {
    style : fixtutupanlahan1
  });
var fix_penerangan=L.geoJSON(fixpenerangan, {
    style : fixpenerangan1
  });

var data_analisa_19=L.geoJSON(analisa2019, {
    style : analisadata2019
  });
...
//untuk PENDEFINISI legenda
      var titikkasus = L.control({position:'topright'});
        ...
        var div=L.DomUtil.create('div','box box-primary');
          ...
          var fix_tutupan_lahan =["Permukiman","Non Permukiman"];

          var fix_penerangan=["Penerangan","Non Penerangan"];

          var data_analisa_19=["Sangat Rawan","Rawan","Tidak Rawan"];
...
//layer peta
     ...
     var baseMaps={
        ...
        'PeneranganLama' : dataLayerLampu1,
        'Tutupan LahanLama' : dataLayerTutupan,
        'Legend marker' : legendMarker,
        'Penerangan' :fix_penerangan,
        'Tutupan Lahan' :fix_tutupan_lahan,
        'Data Analisa 2019' :data_analisa_19,
